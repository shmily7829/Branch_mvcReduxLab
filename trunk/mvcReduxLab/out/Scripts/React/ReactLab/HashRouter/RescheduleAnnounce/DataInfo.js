...
var DataInfoView3_js_1 = require("./widgets/DataInfoView3.js");
var DataInfoView4_js_1 = require("./widgets/DataInfoView4.js");
var DataInfoView5_js_1 = require("./widgets/DataInfoView5.js");
var DataInfoView6_js_1 = require("./widgets/DataInfoView6.js");
        ...
        return (<div>
                <div> 
                    <reactstrap_1.Nav pills horizontal="sm-center">
                        ...
                        <reactstrap_1.NavItem>
                            <reactstrap_1.NavLink active={activeTab === "tab3"} onClick={function () { _this.toggle('tab3'); }}>
                                進港預報
                            </reactstrap_1.NavLink>
                        </reactstrap_1.NavItem>
                        <reactstrap_1.NavItem>
                            <reactstrap_1.NavLink active={activeTab === "tab4"} onClick={function () { _this.toggle('tab4'); }}>
                                實際進港
                            </reactstrap_1.NavLink>
                        </reactstrap_1.NavItem>
                        <reactstrap_1.NavItem>
                            <reactstrap_1.NavLink active={activeTab === "tab5"} onClick={function () { _this.toggle('tab5'); }}>
                                出港預報
                            </reactstrap_1.NavLink>
                        </reactstrap_1.NavItem>
                        <reactstrap_1.NavItem>
                            <reactstrap_1.NavLink active={activeTab === "tab6"} onClick={function () { _this.toggle('tab6'); }}>
                                實際出港
                            </reactstrap_1.NavLink>
                        </reactstrap_1.NavItem>
                    </reactstrap_1.Nav>
                ...
                <reactstrap_1.TabContent activeTab={this.state.activeTab}>
                    ...
                    <reactstrap_1.TabPane tabId="tab3">
                        <DataInfoView3_js_1["default"] dataInfo={dataInfo}/>
                    </reactstrap_1.TabPane>
                    <reactstrap_1.TabPane tabId="tab4">
                        <DataInfoView4_js_1["default"] dataInfo={dataInfo}/>
                    </reactstrap_1.TabPane>
                    <reactstrap_1.TabPane tabId="tab5">
                        <DataInfoView5_js_1["default"] dataInfo={dataInfo}/>
                    </reactstrap_1.TabPane>
                    <reactstrap_1.TabPane tabId="tab6">
                        <DataInfoView6_js_1["default"] dataInfo={dataInfo}/>
                    </reactstrap_1.TabPane>
...
var mapStateToProps = function (state, ownProps) {
    return {
        ...
        dataInfo: state.SuspendAnnounceData.dataInfo
