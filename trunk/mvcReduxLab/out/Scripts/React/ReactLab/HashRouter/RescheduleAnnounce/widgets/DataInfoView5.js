...
/// 出港預報
var DataInfoView5 = function (_a) {
    var dataInfo = _a.dataInfo;
    return (<div>
        <FormInputFields_js_1.FormBlock subTitle="出港簽證資料" noGutters borderless>
            <reactstrap_1.Table bordered hover>
                <tbody>
                    <tr>
        ...
        </FormInputFields_js_1.FormBlock>
        <FormInputFields_js_1.FormBlock subTitle="貨品數量及其他" noGutters borderless>
            <reactstrap_1.Table bordered hover>
                <tbody>
                    <tr>
        ...
        <FormInputFields_js_1.FormBlock subTitle="船員人數" noGutters borderless>
            <reactstrap_1.Table bordered hover>
                <tbody>
                    <tr>
        ...
        <FormInputFields_js_1.FormBlock subTitle="簽證人數" noGutters borderless>
            <reactstrap_1.Table bordered hover>
                <tbody>
                    <tr>
