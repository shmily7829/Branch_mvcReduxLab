...
var AppIndex = function (props) { return (<div className="container">
        <div className="jumbotron">
            <h1>HashRouter測試</h1>
            <p>HashRouter測試...國內固定客輪航班查詢</p>
        </div>
...
exports["default"] = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(AppIndex);
